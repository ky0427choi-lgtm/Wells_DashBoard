...
const INPUT_CONTRACT_VERSION = "meal-input-v2";
...
const FM = {
  ...
  "조식_평일":"c5","조식_주말":"c6","중식_평일":"c7","중식_주말":"c8",
  "석식_평일":"c9","석식_주말":"c10","야식_평일":"c11","야식_주말":"c12",
  ...
  /* ★ v3.9 추가: 재료비(%), WHI 점수 */
  "재료비율":"h4","WHI점수":"h5",
  "금월_평균중식":"m1","전월대비":"m2","조업일수":"m3","월간지표기준연월":"m4"
};
